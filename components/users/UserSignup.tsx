        ...
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              ...
              />
              {errors.firstName && (
                <p className="text-[11px] text-red-600 font-medium mt-1 ml-1">{errors.firstName}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.lastName && (
                <p className="text-[11px] text-red-600 font-medium mt-1 ml-1">{errors.lastName}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.phoneNo && (
                <p className="text-[11px] text-red-600 font-medium mt-1 ml-1">{errors.phoneNo}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.email && (
                <p className="text-[11px] text-red-600 font-medium mt-1 ml-1">{errors.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {errors.password && (
                <p className="text-[11px] text-red-600 font-medium mt-1 ml-1">{errors.password}</p>
              )}
            </div>
