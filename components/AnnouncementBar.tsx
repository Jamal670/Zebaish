...
export const AnnouncementBar: React.FC = () => {
  return (
    <div className="bg-[#050505] text-[#d0d0d0] text-[11px] font-medium tracking-wider uppercase py-2 px-4 md:px-8">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden sm:flex items-center space-x-3 sm:space-x-4 text-[10px] sm:text-[11px]">
